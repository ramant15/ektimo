...
#heading{
   ...
   <link href="{{ asset('/css/jquery.ui.timepicker.css') }}" rel="stylesheet">
 ...
 /* function ajax(callback){
	  ...
	  $.ajax({
    	  url: 'http://54.79.23.80/get_schedule',
    ...
    $( "#end_date" ).datepicker({
    	...
    	$('body').on('click', '#schedule', function(){
         ...
         else 
         {
	    	...
	    	var route = 'http://localhost:8000/save_schedule';
	    	var token = document.getElementById('token').value
	    	$.ajax({
	    	  url: route,
	    	  headers: {'X-CSRF-TOKEN': token},
  ...
  $.getScript('http://arshaw.com/js/fullcalendar-1.6.4/fullcalendar/fullcalendar.min.js',function(){
	...
	<body >
		<div class="container">
			...
			<div class="content">
				<div id="heading"><h1>Schedule for Laboratory </h1></div>
 				...
 				<form class="form-horizontal" method="POST" id="form_data" style="display:block;">
					...
					<input type="hidden" name="order_id" value="<?php echo $exp_val[1]; ?>" id="order_id">
						 ...
						 <div class="col-sm-4">
						  ...
						  <img src="{{ asset('/images/loader.gif') }}"></div>
