<?php /* Smarty version 2.6.18, created on 2015-10-20 18:19:11
         compiled from /home/www/html/public/work-schedule/view/dialogs/dlg_event_edit.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', '/home/www/html/public/work-schedule/view/dialogs/dlg_event_edit.html', 208, false),)), $this); ?>
<style type="text/css">
    #dialog-message {
		height: 100%;
    }
...
" ><?php echo $this->_tpl_vars['item']['name']; ?>
                ...
                <?php if ($this->_tpl_vars['settings']['show_description_field'] == 'on'): ?>
					...
					<?php endif; ?>
						<div class="control-group" style="margin-bottom:1px;">
							<label id="description_label_id" class="control-label">Comment: </label>
							<div class="controls" style="margin-left:0;">
				...
				<!--<input style="float:right;position: relative; top: 5px; left: -6px;" type="checkbox" id="allday_checkbox" /><span id="wholeday_label_id" style="left: -5px;float:right;position: relative; top: 5px;">Hele dag</span>-->
				<br style="clear:both;" />
